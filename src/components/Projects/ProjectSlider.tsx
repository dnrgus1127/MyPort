        ...
        {data.map((item, idx) => {
          return (
            <PhotoFrameItem
              name={item.name}
              key={item.id + "prev"}
              $distance={frameNumber - idx + data.length}
              $trans={calculateTranslate(frameNumber - idx + data.length)}
            >
        ...
        {data.map((item, idx) => {
          return (
            <PhotoFrameItem
              name={item.name}
              key={item.id}
              $distance={frameNumber - idx}
              $trans={calculateTranslate(frameNumber - idx)}
            >
              <img src={`/assets/img/${item.name}.jpg`} alt={item.name + "이미지"} />
            </PhotoFrameItem>
          );
