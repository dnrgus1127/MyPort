...
export const PROJECT_INFOMATION: Array<RepositoryConstant> = [
  ...
  },
  {
    ...
    whyDeveloped:
      "블로그 서비스를 개발해 보며 프론트엔드와 백엔드 사이의 통신, 풀스택으로 개발해 보며 프론트엔드가 처리해야 하는 일, 백엔드가 처리해야 하는 일에 대해서 익힐 수 있었고, 마크다운 파싱, 소셜 로그인을 구현하는 방법, 서버가 데이터를 받거나 주는 방식 등에 대해서 학습하였습니다.",
    review:
